/**
 * Expanded EMG module configuration for the interface part. These settings are pretty much a copy of the EEG module
 * settings for testing purposes and must be updated to fit the needs of the EMG module.
...
export const schemas: InterfaceModuleSchema = safeObjectFrom({
    ...
    instructions: {
        content: '',
        description: 'EMG module instructions.',
        label: {
    ...
    settings: {
        description: 'Electromyography settings.',
        fields: [
            {
                text: 'Memory management',
                type: 'subtitle',
                info: 'Control how EMG resource memory is being managed.',
            },
            {
                component: 'settings-checkbox',
                setting: 'emg.useMemoryManager',
                text: 'Use the application memory manager with EMG resources.',
                type: 'setting',
                memoryManager: true,
            ...
            {
                component: 'settings-checkbox',
                setting: 'emg.unloadOnClose',
                text: 'Unload cached signal data when EMG resources are closed.',
                type: 'setting',
                width: '3em',
            },
            {
            ...
            {
                component: 'settings-checkbox',
                setting: 'emg.displayPolarity',
                text: 'Invert EMG trace polarity.',
                type: 'setting',
            ...
            {
                component: 'settings-checkbox',
                setting: 'emg.antialiasing',
                text: 'Apply antialiasing to EMG traces.',
                type: 'setting',
                width: '3em',
            },
            {
                text: 'Color options',
                type: 'subtitle',
                info: 'Select the color of the EMG traces.',
            },
            {
                component: 'settings-colorpicker',
                setting: 'emg.trace.color',
                text: 'Default color of the EMG traces.',
                type: 'setting',
                width: '3em',
            },
            {
            ...
            {
                component: 'settings-checkbox',
                setting: 'emg.epochMode.onlyFullEpochs',
            ...
            {
                component: 'settings-number',
                setting: 'emg.epochMode.epochLength',
...
export const settings: EmgInterfaceSettings = safeObjectFrom({
    ...
    sensitivity: {
        ...
        uvPerD: {
            availableValues: [10, 20, 30, 50, 70, 100, 200, 300, 400, 500, 1000, 2000, 3000, 5000],
            default: 300,
            scale: 1e-6,
        },
    },
    sensitivityUnit: 'uvPerD',
    services: {},
    timebase: {
        msPerD: {
            availableValues: [5, 8, 10, 15, 20, 25, 30, 35, 40, 45, 50],
            default: 10,
            label: 'ms/Div',
            unit: 'ms/D',
        },
