    ...
    setup () {
        ...
        const accControls = reactive([
            ...
            //////////////////      AUDIO        //////////////////
            {
                ...
                reloadOn: ['property:acc.video-visible', 'property:acc.video-playing', 'action:set-settings-value'],
                type: 'button',
                version: 0,
            },
            {
                ...
                reloadOn: [
                    ...
                    'property:acc.video-visible',
                    'property:acc.video-playing',
            ...
            //////////////////      VIDEO        //////////////////
            {
                ...
                reloadOn: ['property:acc.video-visible'],
                type: 'on-off',
                value: false,
                version: 0,
            },
            ...
            // Inspect tool toggle.
            {
                ...
                reloadOn: ['property:acc.cursor-tool'],
                type: 'on-off',
                value: false,
                version: 0,
            },
            // Sidebar toggle.
            {
                ...
                reloadOn: ['property:acc.open-sidebar'],
                type: 'on-off',
                value: false,
                version: 0,
            },
