<template>
    <div data-component="acc-navigator">
        <div class="time">
...
// Child components
import NavigatorTimeline from './AccNavigatorTimeline.vue'
...
export default defineComponent({
    ...
    props: {
        /** Whether the controls bar is open — owned by the parent to keep
         *  ancillary strips in sync. ACC has no trend controls, so this is
    ...
    setup () {
        ...
        return {
            ...
            // Unsubscribers
            unsubscribe,
            ...useAccContext(useStore(), 'AccNavigator'),
        }
    },
    computed: {
        canvasHeight (): number {
