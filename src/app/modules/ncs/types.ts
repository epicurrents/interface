/**
 * Additions to base NCS module types.
 */
...
export type NcsInterfaceSchemas = InterfaceSchema

export type NcsInterfaceSettings = CommonBiosignalInterfaceSettings & {
    ...
    tools: CommonBiosignalInterfaceSettings['tools'] & {
        ...
        signals: NcsToolProperties[]
    }
    /** Viewport settings for the NCS module. */
    viewport: {
 ...
 */
export type NcsModuleConfiguration = ModuleConfiguration & {
    epochMode?: NcsInterfaceSettings['epochMode']
    extraMontages?: {
        [setup: string]: (BiosignalMontageTemplate | string)[]
    }
    extraSetups?: (ConfigBiosignalSetup | string)[]
    hotkeys?: Partial<NcsInterfaceSettings['hotkeys']>
    navigator?: Partial<NcsInterfaceSettings['navigator']>
    tools?: Partial<NcsInterfaceSettings['tools']>
    trace?: RecursivePartial<NcsInterfaceSettings['trace']>
}

export type NcsNavigationKey = 'ArrowLeft' | 'ArrowRight' | 'PageDown' | 'PageUp'

export type NcsToolProperties = {
    color: SettingsColor
    dasharray?: number[]
    radius?: number
    style?: string
