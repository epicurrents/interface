...
.epicv-light-theme, .epicv-light-theme * {
    ...
    --epicv-background-active: var(--wa-color-neutral-fill-quiet);
    --epicv-background-disabled: #e0e0e0;
    --epicv-background-focus: var(--wa-color-neutral-fill-quiet);
    --epicv-background-hover: var(--wa-color-brand-fill-quiet);
    ...
    --epicv-border: #C0C0C0;
    --epicv-border-active: var(--wa-color-brand-border-loud);
    --epicv-border-faint: #E0E0E0;
    --epicv-border-focus: var(--wa-color-brand-fill-loud);
    --epicv-border-highlight: #A0A0A0;
    --epicv-button-abort-background: #E0402010;
    --epicv-button-abort-border: #E04020;
    --epicv-button-background-hover: var(--wa-color-brand-fill-quiet);
    --epicv-button-border-hover: var(--wa-color-brand-border-loud);
    --epicv-button-confirm-background: #2040E010;
    --epicv-button-confirm-border: var(--wa-color-brand-fill-loud);
    --epicv-error: #cc0000;
    ...
    --epicv-icon-default: var(--wa-color-brand-on-normal);
    --epicv-icon-active: var(--wa-color-brand-on-quiet);
    --epicv-link: var(--wa-color-brand-on-quiet);
    --epicv-text-disabled: #808080;
    --epicv-text-emphasis: var(--wa-color-brand-on-normal);
    --epicv-text-faint: #909090;
    --epicv-text-focus: var(--wa-color-brand-on-quiet);
